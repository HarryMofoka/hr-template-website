        ...
        <div className="pt-20">
            ...
            <section className="py-24 max-w-7xl mx-auto px-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
                    {/* Contact Info */}
                    <div>
                        <h2 className="text-3xl text-white font-semibold uppercase mb-8">Partner With Us</h2>
                        <p className="text-slate-400 mb-12 leading-relaxed">
                            We provide bespoke recruitment solutions tailored to the unique needs of your business.
                            Contact our team to discuss how we can help you build your workforce.
                        </p>
                        ...
                        <div className="space-y-8">
                            <div className="flex items-start gap-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-slate-400">companies@forthepeople.co.za</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-slate-400">+27 10 987 6543</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-slate-900/30 p-8 border border-white/10">
                        <form className="space-y-6">
                            ...
                            <div>
                                <label className="block text-xs font-tech text-slate-500 uppercase tracking-widest mb-2">Requirement Details</label>
